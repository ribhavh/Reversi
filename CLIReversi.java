...
public class CLIReversi {
    ...
    public static void main(String args[]) throws Exception {
        ...
        do {
            ...
            if (curr_state.getSuccessors(player.charAt(0)).size() == 0 ) {
            ...
            // Computer's turn
            if (curr_state.isTerminal()) break;
            if (curr_state.getSuccessors(computer.charAt(0)).size() == 0 ) {
    ...
    private static State getOptimalMove (
        ...
        List<State> successors = curr_state.getSuccessors(player);
